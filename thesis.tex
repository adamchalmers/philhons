...
Agents who follow these alternative theories may not be vulnerable to HULP-exploitation. In HULP problems, the HULP action does not dominate the walk away action, so (depending on how exactly the theory values expected utility) agents are not compelled to pay any price for it.
