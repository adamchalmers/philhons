...
We can put this formally like so:

\begin{center}
FORMAL PROOF GOES HERE
\end{center}

This demonstrates that Eliza can reverse Max's preferences at no cost to herself. Goal-driven agents seek to maintain their preferences \citep{omohundro2008basic,bostrom2012will} (EXPANDED EXPLANATION OF THIS GOES HERE - ASK MARK FOR READINGS ON THIS TOPIC), and therefore an ideal goal-driven agent should not allow themselves to be HULP-exploited.
