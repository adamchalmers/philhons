...
\subsection{How RNP defeats HULP: a formal analysis}

% TODO: content

\subsection{Limits on agency and how to choose epsilon}

In the previous chapter, I claimed it would be arbitrary to insist rational agents use bounded utility functions. However, (RNP) could be seen as equally arbitrary, for two different reasons.
...
I will discuss two motivations for RNP, which defend it from the first charge of arbitrariness. Each motivation leads to an account of how to choose epsilon in a systematic way, which defends RNP from the second charge of arbitrariness.

\subsubsection{Finite deliberation}
